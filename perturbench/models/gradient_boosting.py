...
class GradientBoostingModel(PerturbationModel):
    """Uses a GradientBoostingRegressor for predictions."""

    def __init__(self, device: torch.device, model_name: str = "GradientBoosting Model", **kwargs) -> None:
        self.kwargs = kwargs
        self.device = device
